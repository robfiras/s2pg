...
if __name__ == '__main__':
    ...
    launcher = Launcher(exp_name='gail_rs',
    ...
    for env, d_ent_coef, train_Dth, usn, std, lr, clip_eps_ppo, new_state_update_tau, discrim_mode in\
            product(envs, discrim_ent_coefs, train_D_n_th_epoch, use_next_states, stds, learning_rates,
                    clip_eps_ppos, new_state_update_taus, discrim_modes):
        ...
        launcher.add_experiment(**default_params,
                                ...
                                new_state_update_tau__=new_state_update_tau)
