...
from s2pg.networks.vanilla_networks import PPOWindowNetwork
from s2pg.policy import PPOWindowPolicy
...
def experiment(
    ...
    policy = PPOWindowPolicy(network=PPOWindowNetwork,
                             input_shape=(truncation_length * dim_env_state, ),
                             ...
                             state_mask=np.ones(dim_env_state, dtype=bool),
    ...
    # setup critic
    input_shape_critic = (truncation_length * dim_env_state,)
    critic_params = dict(network=PPOWindowNetwork,
