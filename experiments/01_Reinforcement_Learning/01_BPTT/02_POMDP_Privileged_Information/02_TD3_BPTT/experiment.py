...
from s2pg.policy.recurrent_policy import RecurrentPolicyTD3BPTT_preprocess
from s2pg.networks.recurrent_networks import TD3ActorBPTTNetwork
...
def experiment(
        ...
        std: float = 0.02,
        rnn_type: str = "gru",
        hidden_state_dim_per_layer: int = 128,
    ...
    actor_params = dict(network=TD3ActorBPTTNetwork,
    ...
    # Create the agent
    agent = TD3_BPTT_pI(mdp_info=mdp.info, policy_class=RecurrentPolicyTD3BPTT_preprocess,
