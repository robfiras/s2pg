...
class PointMassPOMDP_v3(Environment):

    def __init__(self, horizon=1000, gamma=0.99, n_steps_action=3, observable_radius=30.0, ff_render_factor=1.0):
        """
        Constructor.
        ...
        self._potential_goal_pos = np.array([[25.0, 130.0], [57.0, 130.0], [88.0, 130.0], [120.0, 130.0]])
...
if __name__=="__main__":
    ...
    mdp = PointMassPOMDP_v3(observable_radius=90)
    for j in range(100):
        state = mdp.reset()
        print("State: ", state)
        for i in range(15):
